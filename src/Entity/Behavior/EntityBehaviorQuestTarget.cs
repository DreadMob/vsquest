...
namespace VsQuest
{
    public class EntityBehaviorQuestTarget : EntityBehavior
    {
        ...
        public override void Initialize(EntityProperties properties, JsonObject attributes)
        {
            ...
            targetId = attributes["targetId"].AsString(null);
            ...
            {
                string waTargetId = entity.WatchedAttributes.GetString("vsquest:killaction:targetid", null);
                if (!string.IsNullOrWhiteSpace(waTargetId)) targetId = waTargetId;
            }
