...

{
...

    {
...

        {
            ...
            ElementBounds clippingBounds = ElementBounds.Fixed(0, 60, mainWidth, 500);
...

            {
                ...
                SingleComposer.GetScrollbar("scrollbar")?.SetNewTotalHeight((float)questTextElement.TotalHeight + 200);
