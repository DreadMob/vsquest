...
namespace VsQuest.Gui.Journal
{
    ...
    public class QuestJournalDialog : GuiDialog
    {
        ...
        private void BuildQuestGiverPages()
        {
            var questGivers = allEntries
        ...
        private void BuildQuestPages()
        {
            foreach (var entry in allEntries)
            {
                string entryTitle = GetEntryTitle(entry);
                allPages.Add(new QuestPage(capi, entry.QuestId, entry.LoreCode, entryTitle));
            }
        }
        ...
        private void OnTabClicked(int index, GuiTab tab)
        {
            ...
            currentCategoryCode = journalTab?.CategoryCode ?? "quests";
        ...
        private void FilterItems()
        {
            ...
            {
                shownPages.Add(new NotesPlaceholderPage(capi));
            }
